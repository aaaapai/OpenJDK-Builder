...
find jdk -name "*.debuginfo" -exec mv {}   dizout/ \;

find jdk/bin jre/bin -type f -exec ${NDK_TOOLCHAIN}/bin/llvm-strip {} \; \
  -o \( -path "jdk/lib" -o -path "jre/lib" \) -type f -name "*.so" -exec ${NDK_TOOLCHAIN}/bin/llvm-strip {} \;